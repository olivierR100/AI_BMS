 ...
 ******************************************************************************/
    ...
    adminAuth: {
        ...
        users: [{
            username: "admin",
            password: "REPLACE_WITH_BCRYPT_HASH", // generate: node-red admin hash-pw
            permissions: "*"
        }],
	tokens: [
        	{
            		token: "REPLACE_WITH_STATIC_API_TOKEN", // long random string; used by the Node-RED MCP server
            		user: "admin",
            		scope: ["*"]
        	}
    		]
