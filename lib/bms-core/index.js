...
module.exports = {
    ...
    installAll(ctx) {
        ...
        // Taxonomie avant les profils COV : ceux-ci s'affectent par étiquette, et
        // la migration des zones doit être faite quand ils se résolvent.
        this.installTags(ctx);
